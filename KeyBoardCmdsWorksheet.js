...
console.log("I should be below 'cut me out' if you did this right!");
...
console.log("MistyHello, my name is Misty")
...
console.log("More copying!");console.log("More copying!");console.log("More copying!");
...
console.log("Cut me out!");console.log("Cut me out!");
...
console.log("Dogs are the prettiest! Dogs are the prettiest! Dogs are the boomdiggity! Dogs are the bomddiggity! Dogs are the boomdiggity! Dogs are the boomdiggity! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best!")
...
// CREATE MULTIPLE CURSORS (alt/option + left click)
// Creating multiple cursors is useful when you want to add the same thing to several different places
console.log("Hello, my name is Misty")
// Hold alt/option then left click here ^ (inside the quotation)
...
// SAVE!!
// Make multiple cursors to add the correct answer in all these console logs!
console.log("The first prime number is: Misty")
console.log("The first prime number is: Misty")
console.log("The first prime number is: Misty")
console.log("The first prime number is: Misty")

console.log("More copying!");console.log("More copying!");console.log("More copying!");console.log("More copying!");
console.log("Now paste the above statement 3 times!")
...
// Change some repetitive part of this statement, you can pick, but make sure you grab ALL instances of the repeat and change it!
console.log("Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are the best! Dogs are man's best friend! Dogs are man's best friend! Dogs are man's best friend! Dogs are man's best friend!")
...
// ctrl shift p - bring up all shortcuts?
// ctrl shift l - select every word in a doc

// ctrl f to find a word but then arrow down and replace that word or replace all those words
